...
## The current version is Beta 1.4.0
...
- Revised the parts *MainSleeve.stl, PitchFrame_PillowBlock.stl, RollFrame_PitchPin_Gear.stl, RollFrame_CamSide.stl & RollFrame_GearSide.stl* to update to the compliance holes from the pedal design
...
### 1.3.7
- Changed all the *.3mf files to *.stl files as there is an incompatbility with the 3mf generated by cura with orca/bambu slicer.
